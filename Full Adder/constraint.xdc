...
set_property PACKAGE_PIN W17 [get_ports {r1[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r1[3]}]
set_property PACKAGE_PIN W15 [get_ports {r2[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r2[0]}]
set_property PACKAGE_PIN V15 [get_ports {r2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r2[1]}]
set_property PACKAGE_PIN W14 [get_ports {r2[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r2[2]}]
set_property PACKAGE_PIN W13 [get_ports {r2[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r2[3]}]
set_property PACKAGE_PIN V2 [get_ports {ci}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ci}]
#set_property PACKAGE_PIN T3 [get_ports {carry}]					
